...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, CompoundButton.OnCheckedChangeListener {
    ...
    String letterList[] = {"QR","About","Permissions"};
    int letterIcon[] = {R.drawable.qr, R.drawable.about, R.drawable.access};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                if(letterList[position] == letterList[1])//About
                {
                    Intent i = new Intent(MainActivity.this, About.class);
                    startActivity(i);
                }
                if(letterList[position] == letterList[2])//Permissions
                {
                    Intent i = new Intent();
